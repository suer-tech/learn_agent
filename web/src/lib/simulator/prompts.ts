...
export const SYSTEM_PROMPTS: PromptOption[] = [
  ...
  },
  {
    ...
    text: "Узнай какие файлы лежат в директории проекта. Тебе доступен инструмент Bash.",
    isSecurityAware: false,
  },
  {
    id: "sp_task3_files",
    label: "Продвинутый файловый агент",
    text: "Проверь наличие файла 'счет на оплату'. Если его нет, создай его. Тебе доступны инструменты поиска (Bash или Search) и создания файлов (Create).",
    isSecurityAware: false,
  },
  {
    id: "sp_basic",
